        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title">Gráfico de Ativos</h5>
                ...
                <div class="card-body">
                    ...
                    <div class="card-footer">
                        <div class="row">
                            <div class="col-sm-4 col-6">
                                <div class="description-block border-right">
                                    <div v-if="(totalsumoperacao > '0')">
                                        <h5 class="description-header text-success" :key="totalsumoperacao"><i class="fas fa-caret-up"></i>{{ totalsumoperacao | toCurrency }}</h5>
                                    </div>
                                    <div v-else>
                                        <h5 class="description-header text-danger" :key="totalsumoperacao"><i class="fas fa-caret-down"></i>{{totalsumoperacao | toCurrency }}</h5>
                                    </div>
                            ...
                            <div class="col-sm-4 col-6">
                                <div class="description-block border-right">
                                    <div v-if="(melhoroperacao > '0')">
                                        <h5 class="description-header text-success" :key="melhoroperacao"><i class="fas fa-caret-up"></i>{{ melhoroperacao | toCurrency  }}</h5>
                                    </div>
                                    <div v-else>
                                        <h5 class="description-header text-danger" :key="melhoroperacao"><i class="fas fa-caret-down"></i>{{melhoroperacao | toCurrency }}</h5>
                                    </div>
                            ...
                            <div class="col-sm-4 col-6">
                                <div class="description-block border-right">
                                    <div v-if="(menoroperacao > '0')" :key="menoroperacao">
  ...
  methods: {
      loadData (){
          ...
          const params = {
           ...
           axios.get('/Controle_Operacional/public/api/charts_ativo',{params})
                    .then(response => {
                        //--Operacoes--//
