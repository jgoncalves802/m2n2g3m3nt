...
<body class="hold-transition sidebar-mini layout-fixed">
  <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <!-- Main content -->
        <form action="{{ route('Cadastrobanca') }}" method="POST">
            @csrf
                              ...
                              <div class="row">
                                <div class="col-sm-6">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="nome_trading_plan" value="{{ old ('nome_trading_plan') }}" placeholder="Nome do Plano">
                                  </div>
                                  <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="corret" value="{{ old ('corret') }}" placeholder="XP / Rico / Modal / Clear etc...">
                                  </div>                                 
